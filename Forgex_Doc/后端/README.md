...
| 部门管理 | 已支持 | Forgex_Sys | 系统管理模块 |
| 职位管理 | 已支持 | Forgex_Sys | 系统管理模块 |
...
| 功能 | 状态 | 模块 | 文档入口 |
|---|---|---|---|
| 站内消息 | 已支持 | Forgex_Sys | [消息模板与 SSE](./配置与审计/消息模板与 SSE.md) |
| 模板消息 | 已支持 | Forgex_Sys | [消息模板与 SSE](./配置与审计/消息模板与 SSE.md) |
| SSE 推送 | 已支持 | Forgex_Sys | [消息模板与 SSE](./配置与审计/消息模板与 SSE.md) |
| 按模板发送 | 已支持 | Forgex_Sys | [消息模板与 SSE](./配置与审计/消息模板与 SSE.md) |
| 按用户发送 | 已支持 | Forgex_Sys | [消息模板与 SSE](./配置与审计/消息模板与 SSE.md) |
...
| 功能 | 状态 | 模块 | 文档入口 |
|---|---|---|---|
| 流程配置 | 已支持 | Forgex_Workflow | [工作流与报表](./模块专题/工作流与报表.md) |
| 发起审批 | 已支持 | Forgex_Workflow | [工作流与报表](./模块专题/工作流与报表.md) |
| 审批处理 | 已支持 | Forgex_Workflow | [工作流与报表](./模块专题/工作流与报表.md) |
| 待办/已办 | 已支持 | Forgex_Workflow | [工作流与报表](./模块专题/工作流与报表.md) |
| 回调注册 | 已支持 | Forgex_Workflow | [工作流与报表](./模块专题/工作流与报表.md) |
| 报表分类 | 已支持 | Forgex_Report | [工作流与报表](./模块专题/工作流与报表.md) |
| 报表数据源 | 已支持 | Forgex_Report | [工作流与报表](./模块专题/工作流与报表.md) |
| 报表模板 | 已支持 | Forgex_Report | [工作流与报表](./模块专题/工作流与报表.md) |
...
- **消息模板**：[消息模板与 SSE](./配置与审计/消息模板与 SSE.md)
...
| Forgex_Workflow | 8084 | 工作流引擎、审批流程 |
| Forgex_Report | 8085 | 报表中心、UReport2、JimuReport |
