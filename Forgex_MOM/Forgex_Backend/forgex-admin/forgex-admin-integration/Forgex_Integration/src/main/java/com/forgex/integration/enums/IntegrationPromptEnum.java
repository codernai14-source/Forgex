...
public enum IntegrationPromptEnum implements I18nPrompt {
    ...
    API_AUTH_FAILED("API_AUTH_FAILED", "接口授权失败：Token 无效或来源 IP 不在白名单中"),
    API_TARGET_ROUTE_REQUIRED("API_TARGET_ROUTE_REQUIRED", "目标接口路由不能为空"),
    API_TARGET_ROUTE_ONLY_PATH("API_TARGET_ROUTE_ONLY_PATH", "目标地址只能填写端口后的接口路由，不能包含 http://、https:// 或 IP/域名"),
    API_OUTBOUND_TARGET_REQUIRED("API_OUTBOUND_TARGET_REQUIRED", "出站目标配置不能为空，请先在接口配置中选择第三方系统"),
    API_THIRD_SYSTEM_IP_REQUIRED("API_THIRD_SYSTEM_IP_REQUIRED", "第三方系统 IP/端口未配置，请先维护第三方系统地址"),
    API_INBOUND_EXECUTE_FAILED("API_INBOUND_EXECUTE_FAILED", "入站接口执行失败：{0}"),
    API_OUTBOUND_EXECUTE_FAILED("API_OUTBOUND_EXECUTE_FAILED", "调用第三方接口失败：{0}"),
    API_TASK_NOT_FOUND("API_TASK_NOT_FOUND", "异步任务结果不存在或已过期"),
    API_TASK_SUBMIT_FAILED("API_TASK_SUBMIT_FAILED", "提交异步接口任务失败：{0}"),
    ...
    THIRD_AUTH_TOKEN_GENERATED("THIRD_AUTH_TOKEN_GENERATED", "Token 生成成功"),
    THIRD_AUTH_TOKEN_VALID("THIRD_AUTH_TOKEN_VALID", "Token 有效"),
    THIRD_AUTH_TOKEN_INVALID("THIRD_AUTH_TOKEN_INVALID", "Token 无效"),
    THIRD_AUTH_IP_IN_WHITELIST("THIRD_AUTH_IP_IN_WHITELIST", "IP 在白名单中"),
    THIRD_AUTH_IP_NOT_IN_WHITELIST("THIRD_AUTH_IP_NOT_IN_WHITELIST", "IP 不在白名单中"),
    THIRD_AUTH_CREATE_SUCCESS("THIRD_AUTH_CREATE_SUCCESS", "第三方授权创建成功"),
    THIRD_AUTH_UPDATE_SUCCESS("THIRD_AUTH_UPDATE_SUCCESS", "第三方授权更新成功"),
    THIRD_AUTH_DELETE_SUCCESS("THIRD_AUTH_DELETE_SUCCESS", "第三方授权删除成功"),
    THIRD_AUTH_BATCH_DELETE_SUCCESS("THIRD_AUTH_BATCH_DELETE_SUCCESS", "第三方授权批量删除成功"),
    THIRD_AUTH_REFRESH_TOKEN_SUCCESS("THIRD_AUTH_REFRESH_TOKEN_SUCCESS", "Token 有效期刷新成功"),

    // ========== 调用日志 ==========
    CALL_LOG_ID_REQUIRED("CALL_LOG_ID_REQUIRED", "调用记录 ID 不能为空"),
    CALL_LOG_NOT_FOUND("CALL_LOG_NOT_FOUND", "调用记录不存在"),
