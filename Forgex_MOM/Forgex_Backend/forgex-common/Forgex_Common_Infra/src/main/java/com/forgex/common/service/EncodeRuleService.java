...
public class EncodeRuleService {
     ...
     */
    private final ObjectProvider<EncodeRuleProvider> encodeRuleFeignClientProvider;
    ...
    public String generateCode(String ruleCode) {
        ...
        EncodeRuleProvider encodeRuleFeignClient = encodeRuleFeignClientProvider.getIfAvailable();
