...
public class TreeSingleCodeGenStrategy extends AbstractCodeGenStrategy {
    ...
    public TreeSingleCodeGenStrategy(CodegenTemplateRenderer templateRenderer) {
    ...
    public List<CodegenRenderFileDTO> generate(CodeGenContextDTO context) {
        ...
        addFile(files, "sql", "sql/03_i18n_message.sql", "tree-single/sql/i18n_message.sql.btl", context);
        addFile(files, "sql", "sql/04_response_message.sql", "tree-single/sql/response_message.sql.btl", context);
        addAndroidFiles(files, androidBasePath, "tree-single/android", context);
