...
public enum SysPromptEnum implements I18nPrompt {
    ...
    ROLE_INVALID_OR_CROSS_TENANT_SINGLE("ROLE_INVALID_OR_CROSS_TENANT_SINGLE", "角色不存在或不属于当前租户"),
    ...
    CODEGEN_DATASOURCE_PASSWORD_DECRYPT_FAILED("CODEGEN_DATASOURCE_PASSWORD_DECRYPT_FAILED", "数据源密码传输解密失败"),
    ...
    MSG_TEMPLATE_CODE_REQUIRED("MSG_TEMPLATE_CODE_REQUIRED", "模板编号不能为空"),
