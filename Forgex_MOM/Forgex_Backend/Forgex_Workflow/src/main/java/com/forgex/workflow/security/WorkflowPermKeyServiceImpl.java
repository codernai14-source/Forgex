...
package com.forgex.workflow.security;
...
/**
 * Workflow 模块 PermKeyService 实现类。
 * <p>
 ...
 * <p>
 * 计算口径（由 Auth 模块实现）：
 * {@code sys_user_role_perm -> sys_role_menu_perm -> sys_menu（含 catalog/menu/button 等 perm_key）}。
 * </p>
 *
 * <p>
...
@Slf4j
@Service
public class WorkflowPermKeyServiceImpl implements PermKeyService {
     ...
     */
    public WorkflowPermKeyServiceImpl(@Lazy AuthPermClient authPermClient) {
