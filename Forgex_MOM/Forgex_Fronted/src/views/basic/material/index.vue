<template>
  <div class="material-page">
    ...
    <a-modal v-model:open="detailVisible" :title="t('basic.material.detail')" width="800px" :footer="null">
...
const dialogTitle = computed(() => (isEdit.value ? t('basic.material.edit') : t('basic.material.add')))
