...
export default {
  ...
  configureStyle: 'Configure style',
  fontFamily: 'Font',
  fontSize: 'Font size',
  fontColor: 'Color',
  ...
  passwordPolicyDesc: 'Configure password storage, default password, complexity, expiration, and reuse history.',
  ...
  passwordMaxAgeDays: 'Password Expiration (days)',
  passwordMaxAgeDaysHint: '0 disables expiration. Level-3 baseline is 90 days. Forced change on login requires compliance level L2/L3.',
  passwordHistoryCount: 'Disallow Reusing Last N Passwords',
  passwordHistoryCountHint: 'New passwords cannot match the current password or the last N passwords. 0 disables the check. Level-3 baseline is at least 5.',
  passwordForceChangeOnFirstLogin: 'Force Change On First Login',
  passwordForceChangeOnFirstLoginHint: 'Users must change the default or reset password before using the system. Requires compliance level L2/L3.',
  ...
  localUploadPathPlaceholder: 'Select backend server upload folder',
