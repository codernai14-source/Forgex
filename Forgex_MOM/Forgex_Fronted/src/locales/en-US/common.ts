...
export default {
  ...
  iconPicker: {
    ...
    libraries: {
      ...
      materialDesign: 'Material Design Icons',
      tabler: 'Tabler Icons',
      heroicons: 'Heroicons',
      carbon: 'Carbon Icons',
  ...
  batchFileUpload: {
    ...
    hintSingle: 'Only one file can be selected',
    selected: 'Files to upload',
    clear: 'Clear',
    remove: 'Remove file',
    formats: 'Accepted: {types}',
    maxCount: 'You can select up to {count} files',
    sizeExceeded: '{name} exceeds the {size} size limit',
  },
  ...
  login: {
    ...
    mfaHint: 'Enter the 6-digit authenticator code or a one-time recovery code.',
    mfaPlaceholder: 'OTP / recovery code',
    mfaSubmit: 'Verify',
    forceChangeTitle: 'Change password',
    forceChangeHint: 'Your password has expired or must be changed before you can continue.',
