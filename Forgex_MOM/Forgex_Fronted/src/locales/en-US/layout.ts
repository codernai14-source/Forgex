...
export default {
  ...
  user: {
    ...
    refreshPermissions: 'Refresh Menu Permissions',
    refreshPermissionsLoading: 'Refreshing Menu Permissions...',
    refreshPermissionsSuccess: 'Menu permissions refreshed',
    refreshPermissionsFailed: 'Failed to refresh menu permissions. Please try again later.',
  ...
  help: {
    ...
    scopeMenu: 'Page specific',
    scopeGlobal: 'Global default',
    sourceFile: 'Uploaded file',
    sourceExternal: 'External link',
    emptyDocs: 'No documents yet. You can contact us first.',
    selectDoc: 'Select a document on the left',
    gotoMaintain: 'Maintain this page',
    gotoMaintainContact: 'Maintain contact info',
    phone: 'Phone',
    email: 'Email',
    workTime: 'Working hours',
    address: 'Address',
    remark: 'Remark',
    wechatQr: 'WeCom QR code',
    previewLoading: 'Loading preview',
    previewFailed: 'This file cannot be previewed. Open it in a new window or download it.',
    docNotPreviewable: 'Legacy .doc files cannot be previewed. Download or convert to docx.',
