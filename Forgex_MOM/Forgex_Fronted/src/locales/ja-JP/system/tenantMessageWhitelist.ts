...
export default {
  title: 'テナントメッセージホワイトリスト',
  guide: {
    title: '用途説明',
    description: 'テナントメッセージホワイトリストは、テナント間メッセージ送信権限を制御します。送信元テナントが送信先テナントへの送信を許可されている場合のみ、クロステナントのメッセージ配信が可能です。同一テナント内のメッセージとプラットフォームテナント（tenantId=0）は制限されません。',
  },
  modal: {
    addTitle: 'ホワイトリスト追加',
    editTitle: 'ホワイトリスト編集',
