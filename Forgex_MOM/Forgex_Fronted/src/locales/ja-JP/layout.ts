...
export default {
  ...
  user: {
    ...
    guideSettings: 'ガイド設定',
    sendMessage: 'メッセージ送信',
    refreshPermissions: 'メニュー権限を更新',
    refreshPermissionsLoading: 'メニュー権限を更新中...',
    refreshPermissionsSuccess: 'メニュー権限を更新しました',
    refreshPermissionsFailed: 'メニュー権限の更新に失敗しました。しばらくしてから再試行してください。',
  ...
  help: {
    ...
    scopeMenu: 'このページ専用',
    scopeGlobal: '共通マニュアル',
    sourceFile: 'アップロードファイル',
    sourceExternal: '外部リンク',
    emptyDocs: '資料がありません。先にお問い合わせください。',
    selectDoc: '左側の資料を選択してください',
    gotoMaintain: 'このページの資料を管理',
    gotoMaintainContact: '連絡先を管理',
    phone: '電話番号',
    email: 'メール',
    workTime: '対応時間',
    address: '住所',
    ...
    previewFailed: 'このファイルはプレビューできません。新しいウィンドウで開くかダウンロードしてください。',
    docNotPreviewable: '旧形式の .doc はプレビューできません。ダウンロードするか docx に変換してください。',
