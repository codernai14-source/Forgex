...
export default {
  ...
  user: {
    ...
    guideSettings: '引导设置',
    sendMessage: '发送消息',
    refreshPermissions: '刷新菜单权限',
    refreshPermissionsLoading: '正在刷新菜单权限...',
    refreshPermissionsSuccess: '菜单权限已刷新',
    refreshPermissionsFailed: '菜单权限刷新失败，请稍后重试',
  ...
  help: {
    ...
    sourceFile: '上传文件',
    sourceExternal: '外部链接',
    emptyDocs: '暂无文档，可先查看联系我们',
    selectDoc: '请选择左侧文档',
    gotoMaintain: '维护本页文档',
    gotoMaintainContact: '维护联系方式',
    phone: '联系电话',
    email: '邮箱',
    workTime: '工作时间',
    address: '地址',
    ...
    previewFailed: '当前文件无法在线预览，可新窗口打开或下载',
    docNotPreviewable: '旧版 .doc 不支持站内预览，请下载或转存为 docx',
    openNewWindow: '新窗口打开',
    download: '下载',
  },
