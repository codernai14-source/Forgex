...
export default {
  ...
  module: {
    ...
    widgets: {
      ...
      customerInfo: { title: '客戶信息', subtitle: '客戶主數據與對接維護', summary: '管理客戶檔案、聯繫人、發票信息與第三方同步狀態。' },
      workCalendarInfo: { title: '工作日曆', subtitle: '工作日與假日維護', summary: '維護基本信息模塊的工作日、節假日和排班事件。' },
    ...
    stats: {      masterData: '主數據', customerArchive: '客戶檔案', integration: '對接', thirdPartySync: '第三方同步', calendar: '日曆', workdayMaintain: '工作日維護', event: '事件', holidayShift: '節假調休', supplierArchive: '供應商檔案', approval: '審批', admissionChange: '准入/變更', rule: '規則', byModule: '按模塊維護', capability: '能力', testGenerate: '測試/生成', user: '用戶', accountManage: '賬號管理', role: '角色', authConfig: '授權配置', status: '狀態', onlineSession: '在線/會話', security: '安全', loginAudit: '登錄審計', audit: '審計', operationLog: '操作日誌', trace: '追蹤', loginRecord: '登錄記錄', scope: '範圍', publicTenant: '公共/租戶', config: '配置', systemParams: '系統參數', pending: '待辦', myTasks: '我的任務', processed: '已辦', processRecord: '處理記錄', entry: '入口', startApproval: '發起審批', flow: '流程', taskTemplate: '任務模板', action: '動作', approveReject: '同意/駁回', task: '任務', flowConfig: '流程配置', node: '節點', approvalRule: '審批規則', type: '類型', extension: '擴展', enabled: '已啟用', pendingApproval: '待審批', externalApi: 'External APIs', success: 'Success', callSuccess: 'Call success', fail: 'Failure', callFail: 'Call failure', callStatus: 'Call status', callTrace: 'Call trace', trend: 'Trend', last14Days: 'Last 14 days', call: 'Call', callCount: 'Call count', api: 'API', hotApi: 'Hot API', successRate: 'Success rate', quality: 'Quality', exception: 'Exception', failureTrace: 'Failure trace', callAudit: 'Call audit',
    },
  }
}
