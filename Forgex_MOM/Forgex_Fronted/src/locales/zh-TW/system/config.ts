...
export default {
  ...
  passwordPolicy: '密碼策略',
  passwordPolicyDesc: '配置密碼存儲加密方式、預設密碼、複雜度、過期時間和禁止重複次數。',
  ...
  passwordMaxAgeDays: '密碼過期時間 (天)',
  passwordMaxAgeDaysHint: '0 表示不過期。等保建議 90 天。到期後下次登入強制改密，需合規等級 L2/L3。',
  passwordHistoryCount: '禁止重複使用最近密碼次數',
  passwordHistoryCountHint: '定期改密時不允許與當前密碼及最近 N 次歷史密碼相同。0 表示不限制，等保建議不少於 5 次。',
  passwordForceChangeOnFirstLogin: '首次登入強制修改密碼',
  passwordForceChangeOnFirstLoginHint: '新用戶或管理員重置默認密碼後，下次登入必須先改密。需合規等級 L2/L3。',
