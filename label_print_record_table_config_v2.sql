...
-- 1. 先删除现有配置（如果存在）
DELETE FROM fx_table_column_config WHERE table_code = 'label_print_record_table';
DELETE FROM fx_table_config WHERE table_code = 'label_print_record_table';
